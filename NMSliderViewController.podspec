#
# Be sure to run `pod spec lint NMSliderViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A sliding view controller handler"
  # s.description  = <<-DESC
  #                   An optional longer description of NMSliderViewController
  #
  #                   * Markdown format.
  ...
  # s.authors      = { "Nick McGuire" => "pudgeball@me.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Nick McGuire', 'other author'
